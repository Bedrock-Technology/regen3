...
func (_Restaking *RestakingTransactor) ClaimDelayedWithdrawals(opts *bind.TransactOpts, maxNumberOfWithdrawalsToClaim *big.Int) (*types.Transaction, error) {
	return _Restaking.contract.Transact(opts, "claimDelayedWithdrawals", maxNumberOfWithdrawalsToClaim)
}

// ClaimDelayedWithdrawals is a paid mutator transaction binding the contract method 0xd44e1b76.
//
// Solidity: function claimDelayedWithdrawals(uint256 maxNumberOfWithdrawalsToClaim) returns()
func (_Restaking *RestakingSession) ClaimDelayedWithdrawals(maxNumberOfWithdrawalsToClaim *big.Int) (*types.Transaction, error) {
	return _Restaking.Contract.ClaimDelayedWithdrawals(&_Restaking.TransactOpts, maxNumberOfWithdrawalsToClaim)
}

// ClaimDelayedWithdrawals is a paid mutator transaction binding the contract method 0xd44e1b76.
//
// Solidity: function claimDelayedWithdrawals(uint256 maxNumberOfWithdrawalsToClaim) returns()
func (_Restaking *RestakingTransactorSession) ClaimDelayedWithdrawals(maxNumberOfWithdrawalsToClaim *big.Int) (*types.Transaction, error) {
	return _Restaking.Contract.ClaimDelayedWithdrawals(&_Restaking.TransactOpts, maxNumberOfWithdrawalsToClaim)
}
...
func (_Restaking *RestakingTransactor) WithdrawBeforeRestaking(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Restaking.contract.Transact(opts, "withdrawBeforeRestaking")
}

// WithdrawBeforeRestaking is a paid mutator transaction binding the contract method 0xbaa7145a.
//
// Solidity: function withdrawBeforeRestaking() returns()
func (_Restaking *RestakingSession) WithdrawBeforeRestaking() (*types.Transaction, error) {
	return _Restaking.Contract.WithdrawBeforeRestaking(&_Restaking.TransactOpts)
}

// WithdrawBeforeRestaking is a paid mutator transaction binding the contract method 0xbaa7145a.
//
// Solidity: function withdrawBeforeRestaking() returns()
func (_Restaking *RestakingTransactorSession) WithdrawBeforeRestaking() (*types.Transaction, error) {
	return _Restaking.Contract.WithdrawBeforeRestaking(&_Restaking.TransactOpts)
}
