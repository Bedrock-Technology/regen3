...
// ActivateRestaking is a paid mutator transaction binding the contract method 0x131aa54d.
//
// Solidity: function activateRestaking(uint256 index) returns()
func (_Restaking *RestakingTransactor) ActivateRestaking(opts *bind.TransactOpts, index *big.Int) (*types.Transaction, error) {
	return _Restaking.contract.Transact(opts, "activateRestaking", index)
}

// ActivateRestaking is a paid mutator transaction binding the contract method 0x131aa54d.
//
// Solidity: function activateRestaking(uint256 index) returns()
func (_Restaking *RestakingSession) ActivateRestaking(index *big.Int) (*types.Transaction, error) {
	return _Restaking.Contract.ActivateRestaking(&_Restaking.TransactOpts, index)
}

// ActivateRestaking is a paid mutator transaction binding the contract method 0x131aa54d.
//
// Solidity: function activateRestaking(uint256 index) returns()
func (_Restaking *RestakingTransactorSession) ActivateRestaking(index *big.Int) (*types.Transaction, error) {
	return _Restaking.Contract.ActivateRestaking(&_Restaking.TransactOpts, index)
}
...
// VerifyAndProcessWithdrawals is a paid mutator transaction binding the contract method 0x97129057.
//
// Solidity: function verifyAndProcessWithdrawals(uint256 podId, uint64 oracleTimestamp, (bytes32,bytes) stateRootProof, (bytes,bytes,bytes,bytes,bytes,uint64,uint64,uint64,bytes32,bytes32,bytes32,bytes32)[] withdrawalProofs, bytes[] validatorFieldsProofs, bytes32[][] validatorFields, bytes32[][] withdrawalFields) returns()
func (_Restaking *RestakingTransactor) VerifyAndProcessWithdrawals(opts *bind.TransactOpts, podId *big.Int, oracleTimestamp uint64, stateRootProof BeaconChainProofsStateRootProof, withdrawalProofs []BeaconChainProofsWithdrawalProof, validatorFieldsProofs [][]byte, validatorFields [][][32]byte, withdrawalFields [][][32]byte) (*types.Transaction, error) {
	return _Restaking.contract.Transact(opts, "verifyAndProcessWithdrawals", podId, oracleTimestamp, stateRootProof, withdrawalProofs, validatorFieldsProofs, validatorFields, withdrawalFields)
}

// VerifyAndProcessWithdrawals is a paid mutator transaction binding the contract method 0x97129057.
//
// Solidity: function verifyAndProcessWithdrawals(uint256 podId, uint64 oracleTimestamp, (bytes32,bytes) stateRootProof, (bytes,bytes,bytes,bytes,bytes,uint64,uint64,uint64,bytes32,bytes32,bytes32,bytes32)[] withdrawalProofs, bytes[] validatorFieldsProofs, bytes32[][] validatorFields, bytes32[][] withdrawalFields) returns()
func (_Restaking *RestakingSession) VerifyAndProcessWithdrawals(podId *big.Int, oracleTimestamp uint64, stateRootProof BeaconChainProofsStateRootProof, withdrawalProofs []BeaconChainProofsWithdrawalProof, validatorFieldsProofs [][]byte, validatorFields [][][32]byte, withdrawalFields [][][32]byte) (*types.Transaction, error) {
	return _Restaking.Contract.VerifyAndProcessWithdrawals(&_Restaking.TransactOpts, podId, oracleTimestamp, stateRootProof, withdrawalProofs, validatorFieldsProofs, validatorFields, withdrawalFields)
}

// VerifyAndProcessWithdrawals is a paid mutator transaction binding the contract method 0x97129057.
//
// Solidity: function verifyAndProcessWithdrawals(uint256 podId, uint64 oracleTimestamp, (bytes32,bytes) stateRootProof, (bytes,bytes,bytes,bytes,bytes,uint64,uint64,uint64,bytes32,bytes32,bytes32,bytes32)[] withdrawalProofs, bytes[] validatorFieldsProofs, bytes32[][] validatorFields, bytes32[][] withdrawalFields) returns()
func (_Restaking *RestakingTransactorSession) VerifyAndProcessWithdrawals(podId *big.Int, oracleTimestamp uint64, stateRootProof BeaconChainProofsStateRootProof, withdrawalProofs []BeaconChainProofsWithdrawalProof, validatorFieldsProofs [][]byte, validatorFields [][][32]byte, withdrawalFields [][][32]byte) (*types.Transaction, error) {
	return _Restaking.Contract.VerifyAndProcessWithdrawals(&_Restaking.TransactOpts, podId, oracleTimestamp, stateRootProof, withdrawalProofs, validatorFieldsProofs, validatorFields, withdrawalFields)
}
